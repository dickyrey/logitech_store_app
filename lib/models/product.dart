...
List<Product> recommendedList = [
  Product(
    ...
    image: "assets/images/mx-anywhere-2s.png",
  ),
  Product(
    name: "LOGITECH PEBBLE M350",
    price: "24,91",
    dpi: "21,000",
    image: "assets/images/logitech-pebble-m350.png",
    description:
  ...
  Product(
    ...
    price: "30,23",
    dpi: "24,003",
    image: "assets/images/disney-marvel-collection.png",
    description:
        "Sambutlah MX Anywhere 2S yang ringkas dan andal, serta menyediakan daya guna lebih bagi Anda. MX Anywhere 2S dapat digunakan di mana pun Anda berada; gerai kopi, kursi pesawat terbang, kamar hotel, atau tempat meeting di luar kantor; dan bekerja lebih lancar di antara tiga komputer, seperti bernavigasi dan melakukan copy-paste di antara ketiganya.",
  ),
  Product(
    ...
    price: "80,12",
    dpi: "14,000",
    image: "assets/images/doodle-collection.png",
    description:
        "Sambutlah MX Anywhere 2S yang ringkas dan andal, serta menyediakan daya guna lebih bagi Anda. MX Anywhere 2S dapat digunakan di mana pun Anda berada; gerai kopi, kursi pesawat terbang, kamar hotel, atau tempat meeting di luar kantor; dan bekerja lebih lancar di antara tiga komputer, seperti bernavigasi dan melakukan copy-paste di antara ketiganya.",
  ),
  Product(
    ...
    price: "80,12",
    dpi: "40,000",
    image: "assets/images/m720-triathlon-mouse.png",
    description:
        "Sambutlah MX Anywhere 2S yang ringkas dan andal, serta menyediakan daya guna lebih bagi Anda. MX Anywhere 2S dapat digunakan di mana pun Anda berada; gerai kopi, kursi pesawat terbang, kamar hotel, atau tempat meeting di luar kantor; dan bekerja lebih lancar di antara tiga komputer, seperti bernavigasi dan melakukan copy-paste di antara ketiganya.",
  ),
];
